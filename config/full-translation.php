...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | All locales your application supports. Can be a simple array of codes:
    |   ['en', 'fr', 'es']
    |
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Custom order for locales in the language switcher. If empty, locales
    | are displayed in the order they appear in supported_locales.
    | Only applicable when supported_locales is a rich metadata array.
    |
    | Example: ['es', 'fr', 'en']
    */
    'locales_order' => [],
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Use Session for Locale Persistence
    |--------------------------------------------------------------------------
    */
    'use_session' => true,
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | URL patterns that should not be processed by locale middleware.
    | Supports exact matches and wildcards (e.g., '/nova', '/nova/*').
    |
    */
    'urls_ignored' => [],
    ...
    |--------------------------------------------------------------------------
    |
    | HTTP methods that should skip locale processing. Useful to avoid
    ...
    */
    ...
    | For example, if 'resources' is in scan_paths, add 'ignored' to
    | exclude 'resources/ignored'.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | File patterns to scan for translatable strings.
    |
    */
    'file_patterns' => [
        '*.php',
    ...
    /*
    |--------------------------------------------------------------------------
    | Allow Newlines in Translations
    |--------------------------------------------------------------------------
    |
    | When false, strings containing newlines are skipped during scanning.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | When true, translation keys are sorted alphabetically in exported files.
    |
    */
    'sort_keys' => true,
    ...
    /*
    |--------------------------------------------------------------------------
    | Add Manual Strings to Translations
    |--------------------------------------------------------------------------
    |
    | When true, strings from manual-strings.json are automatically added
    | to translation files on export if they don't exist.
    |
    */
    'add_manual_strings' => true,
    ...
    |--------------------------------------------------------------------------
    |
    | When true, Laravel PHP translation keys are excluded from JSON export
    | if they have corresponding translations in the language files.
    |
    */
    'exclude_translation_keys' => true,

    /*
    |--------------------------------------------------------------------------
    | Translated String Sort Order
    |--------------------------------------------------------------------------
    |
    | Controls where already-translated strings appear in exported JSON files.
    | Only applies when sort_keys is false.
    |
    | - "alpha":  All keys sorted alphabetically (default).
    | - "top":    Already-translated strings at the top, untranslated at the bottom.
    | - "bottom": Untranslated strings at the top, translated at the bottom.
    |
    */
    'translated_sort_order' => 'alpha',
